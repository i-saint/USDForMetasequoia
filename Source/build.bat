...
:DoBuild
    ...
    copy _out\Win32_Release\%MQ_VERSION%\mqabcImporter.dll "%DIST_IMPORT32%"
    copy _out\Win32_Release\%MQ_VERSION%\mqusdImporter.dll "%DIST_IMPORT32%"
    copy _out\Win32_Release\%MQ_VERSION%\mqabcExporter.dll "%DIST_EXPORT32%"
    copy _out\Win32_Release\%MQ_VERSION%\mqusdExporter.dll "%DIST_EXPORT32%"
    ...
    copy _out\x64_Release\%MQ_VERSION%\mqabcImporter.dll "%DIST_IMPORT64%"
    copy _out\x64_Release\%MQ_VERSION%\mqusdImporter.dll "%DIST_IMPORT64%"
    copy _out\x64_Release\%MQ_VERSION%\mqabcExporter.dll "%DIST_EXPORT64%"
    copy _out\x64_Release\%MQ_VERSION%\mqusdExporter.dll "%DIST_EXPORT64%"
